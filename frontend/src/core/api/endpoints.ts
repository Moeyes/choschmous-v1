export const API = {
  ...
  participation: {
    ...
    reviewOrg: (orgId: number) => `/api/participation-per-sport/org/${orgId}/review`,
  },
  ...
  sportSubmissions: {
    ...
    reviewOrg: (orgId: number) => `/api/events/sport-org/org/${orgId}/review`,
  },
  ...
  categorySubmissions: {
    ...
    reviewSport: (sportId: number) => `/api/surveys/category/submissions/sport/${sportId}/review`,
  },
  survey: {
  ...
  bycategory: {
    ...
    categories: (eventId: number, sportId: number) => `/api/surveys/category?event_id=${eventId}&sport_id=${sportId}`,
  ...
  openSurvey: {
    ...
    responses: (eventId: number, organizationId?: number) => `/api/surveys/open/responses?event_id=${eventId}` + (organizationId ? `&organization_id=${organizationId}` : ''),
    ...
    fields: (eventId: number, includeInactive = false) => `/api/surveys/open/fields?event_id=${eventId}` + (includeInactive ? '&include_inactive=true' : ''),
