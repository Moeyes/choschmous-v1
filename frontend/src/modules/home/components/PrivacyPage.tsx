...
export function PrivacyPage() {
    ...
    const tp = useTranslations('home.privacy');

    const sections = ['collection', 'use', 'retention', 'rights'] as const;
        ...
        <div className="min-h-screen bg-background">
            ...
            <main className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
                ...
                <div className="mb-8 flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-heading sm:text-3xl">{tp('title')}</h1>
                        <p className="text-sm text-muted-foreground">{tp('subtitle')}</p>
                    </div>
                </div>

                <p className="mb-8 leading-relaxed text-muted-foreground">{tp('intro')}</p>
